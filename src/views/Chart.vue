      ...
      >
        <el-row :gutter="48">
          <el-col :span="6">
            <el-card shadow="always">
              <a href="#"><a-icon type="team" style="font-size:50px"/></a>
              <div class="cardtext">
                访客
                <p>265456</p>
              </div>
          ...
          <el-col :span="6">
            <el-card shadow="always">
              <a href="#"><a-icon type="message" style="font-size:50px"/></a>
              <div class="cardtext">
                消息
                <p>125436</p>
              </div>
          ...
          <el-col :span="6">
            <el-card shadow="always">
              <a href="#"><a-icon type="dollar" style="font-size:50px"/></a>
              <div class="cardtext">
                金额
                <p>256458</p>
              </div>
          ...
          <el-col :span="6">
            <el-card shadow="always">
              <a href="#"
                ><a-icon type="shopping-cart" style="font-size:50px"
              /></a>
              <div class="cardtext">
                订单
                <p>562486</p>
        ...
        <el-row :gutter="48">
          <el-col :span="8" style="margin-top:20px">
            <el-card shadow="always" style="height:350px">
